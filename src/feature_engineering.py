...
def load_data(file_path: str) ->pd.DataFrame:
    ...
    try:
        ...
        logger.debug('Data loded  and NaNs filled from: %s', file_path)
        return df
        ...
        logger.error('Unexpected error occure while loading data: %s', e)
        raise
...
def main():
    try:
        ...
        logging.error('failed to complete the feature engineeering process: %s', e)
        print(f"Error:{e}")
