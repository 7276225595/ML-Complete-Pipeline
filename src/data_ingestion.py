...
def load_data(data_url: str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('Fail to parse CSV: %s', e)
        raise
    except Exception as e:
        logger.error('Unxpected error while loading the data: %s', e)
        raise
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('Missing column in dtaframe: %s', e)
        raise
    except Exception as e:
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    ...
    try:
        ...
        logger.error('Unexpected error occurred while savinag data: %s', e)
        raise
